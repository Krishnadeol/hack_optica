          ...
          <VerticalTimelineElement key={element.id}>
            ...
            >
              ...
              <div className="location-time text-center text-gray-700">
                <p className="vertical-timeline-element-subtitle flex justify-center items-center text-white font-bold">
                  <FaLocationDot />{element.location}
                </p>
                <p className="vertical-timeline-element-subtitle flex justify-center items-cente  text-white font-bold">
                  <FaClock />{element.time}
                </p>
              </div>
            </motion.div>
